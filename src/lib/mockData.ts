...
export const merchants: Merchant[] = [
  {
    ...
    name: 'Maya Dupont',
    bio: 'Nail artist · Gel & nail art specialist · 5+ years · Paris 11e',
    ...
    services: [
      {
        id: 's1',
        name: 'Full Set Gel',
        description: 'Complete gel manicure with UV gel, includes simple design of your choice.',
        price: 75,
        duration: 90,
        deposit: 25,
        is_featured: true,
      },
      {
        id: 's2',
        name: 'Gel Infill',
        description: '3-week infill with repairs included.',
        price: 50,
        duration: 60,
        deposit: 15,
      },
      {
        id: 's3',
        name: 'Prestige Nail Art',
        description: 'Custom design, chrome, gradients, complex nail art. Price on request.',
        price: 120,
        duration: 150,
        deposit: 40,
      },
      {
        ...
        description: 'Full hand treatment with semi-permanent polish application.',
        price: 35,
        duration: 45,
        deposit: 10,
      },
      {
        id: 's5',
        name: 'Capsule Extensions',
        description: 'Full set of nail tips with gel overlay for lasting length.',
        price: 90,
        duration: 120,
        deposit: 30,
      },
